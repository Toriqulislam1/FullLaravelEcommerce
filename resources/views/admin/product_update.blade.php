              ...
              aria-label="Close" aria-hidden="true">x</button>
                ...
                <h2 > update product</h2>
                    ...
                    <form action="{{url('product_update',$product->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <input class="text-dark" type="text" placeholder="write a title" name="title" value="{{$product->title}}">
                        </div>
                        
                        <div class="p-2 ">
                        <label class="d-inline-block" for="title">decription :</label>
                        <input class="text-dark" type="text" placeholder="write a decription" name="decription" value="{{$product->decription}}">
                        </div>
                        
                        <div class="p-2 ">
                        <label class="d-inline-block" for="title">price :</label>
                        <input class="text-dark" type="number" placeholder="write a price" name="price" value="{{$product->price}}">
                        </div>
                       
                        <div class="p-2 ">
                        <label class="d-inline-block" for="title">discunt price :</label>
                        <input class="text-dark" type="number" placeholder="write a discunt price" name="discunt_price" value="{{$product->discunt_price}}">
                        </div>
                    
                        <div class="p-2 ">
                        <label class="d-inline-block" for="title">quantity :</label>
                        <input class="text-dark" type="number" placeholder="write a quantity" name="quantity" value="{{$product->quantity}}">
                        </div>
                        <div class="p-2 ">
                       ...
                       <div >
                        ...
                        <option selected="">catagory here</option>
                        @foreach($catagory as $catagory)
                            <option class="text-dark" value="{{$catagory->catagory}}">
                            {{$catagory->catagory}}
                            </option>
                       @endforeach
                        </select>
